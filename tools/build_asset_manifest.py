...
SOURCE_FILES = {
    ...
    "5-6": [
        ...
        ("56_06_magic_school_flying_match.png", "56_06_magic_school_flying_match_v2.png", "RENAMED", "Final v2 used; helmet, gloves and broom verified."),
        ("56_07_magic_school_potion.png", "56_07_magic_school_potion_v2.png", "RENAMED", "Final v2 used; mushrooms on table verified."),
        ("movers_05_animal_city_fox_rabbit.png", "movers_05_animal_city_fox_rabbit.png", "OK", "Fox, rabbit and green shirt verified."),
        ("movers_06_animal_city_sloth_drivers(2).png", "movers_06_animal_city_sloth_drivers.png", "RENAMED", "Available final scene used; fast red car verified."),
        ("56_10_baba_yaga_highest_loudest.png", "56_10_baba_yaga_highest_loudest_v2.png", "RENAMED", "Final v2 used; Baba Yaga highest and singing verified."),
        ("Movers_08_anime_city_offer_icecream.png", "Movers_08_anime_city_offer_icecream.png", "OK", "Ice-cream preference scene verified."),
        ...
        ("movers_14_baba_yaga_koschei_housework.png", "movers_14_baba_yaga_koschei_housework.png", "OK", "Dirty dishes scene verified."),
        ("56_17_superhero_join_battle.png", "56_17_superhero_join_battle.png", "OK", "Request and invitation to join team verified."),
        ("56_18_miles_meets_gwen_tuesday.png", "56_18_miles_meets_gwen_tuesday.png", "OK", "Agreed meeting and exact Tuesday text verified."),
        ("movers_19_minecraft_build_house(1).png", "movers_19_minecraft_build_house.png", "RENAMED", "Available final scene used; planned build verified."),
        ("movers_20_minecraft_creeper(1).png", "movers_20_minecraft_creeper.png", "RENAMED", "Available final scene used; sudden help decision verified."),
    ],
}
